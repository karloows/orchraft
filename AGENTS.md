...
- `.claude/skills/ship/SKILL.md` and `.claude/skills/land/SKILL.md`: Claude
  skill symlinks so Claude sessions can use `/ship` and `/land` while reading
  the same canonical skill files.
