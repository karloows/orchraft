...
| `muster` | status | Reports actionable open-PR state across every repo the account owns — failing/pending checks, merge conflicts, unresolved review threads. Read-only. |
